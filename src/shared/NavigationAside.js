                ...
                <nav className='w-full' >
                    ...
                    <div className="flex flex-col w-full" >
                        {sideNavigation.map((navItem) => (
                            <Link key={navItem.id} to={navItem.route} className={`${currentPath.pathname === navItem.route ? 'bg-indigo-50/50 text-indigo-500 font-medium hover:opacity-100' : 'text-zinc-500/90' } nav-item`} >
